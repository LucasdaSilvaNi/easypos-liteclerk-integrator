...
namespace EasyPOS.Reports
{
    public partial class RepDeliveryReceiptReportForm : Form
    {
        ...
        public RepDeliveryReceiptReportForm(Int32 salesId, Int32 collectionId, Boolean isReprinted, String printerName, String printerFileName, Boolean filterIsWithdrawal)
        {
            InitializeComponent();
            ...
            isWithdrawal = filterIsWithdrawal;
        ...
        private void printDocumentDeliveryReceipt_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            if (collection.Any())
            {
                ...
                Int32 rectangleSizeWidthItemColumn = 150;
                if (isWithdrawal == true)
                {
                    rectangleSizeWidthItemColumn = 320;
                }
                ...
                RectangleF itemHeaderRectangle = new RectangleF
                {
                    X = x,
                    Y = y + 5,
                    Size = new Size(rectangleSizeWidthItemColumn, ((int)graphics.MeasureString("Description", fontArial11Bold, rectangleSizeWidthItemColumn, StringFormat.GenericTypographic).Height))
                };
                ...
                if (collection.FirstOrDefault().TrnSale.TrnSalesLines.Any())
                {
                    ...
                    foreach (var salesLine in salesLines)
                    {
                        ...
                        RectangleF itemRectangle = new RectangleF
                        {
                            X = x,
                            Y = y + 5,
                            Size = new Size(rectangleSizeWidthItemColumn, ((int)graphics.MeasureString(item, fontArial10Regular, rectangleSizeWidthItemColumn, StringFormat.GenericTypographic).Height))
                        };
                        ...
                        {
                            float[] rectangleHeights = new float[3] {
                                itemRectangle.Size.Height,
                                quantityRectangle.Size.Height,
                                unitRectangle.Size.Height
                            };
