...
{
    public partial class MstItemDetailItemPriceDetailForm : Form
    {
        MstItemDetailForm mstItemDetailForm;
        Entities.MstItemPriceEntity mstItemPriceEntity;

        public MstItemDetailItemPriceDetailForm(MstItemDetailForm itemDetailForm, Entities.MstItemPriceEntity itemPriceEntity)
        {
            InitializeComponent();
