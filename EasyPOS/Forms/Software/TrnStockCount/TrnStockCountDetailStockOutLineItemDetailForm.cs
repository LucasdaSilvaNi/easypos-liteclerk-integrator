...
{
    public partial class TrnStockCountDetailStockCountLineItemDetailForm : Form
    {
        public TrnStockCountDetailForm trnStockCountDetailForm;
        public Entities.TrnStockCountLineEntity trnStockCountLineEntity;

        public TrnStockCountDetailStockCountLineItemDetailForm(TrnStockCountDetailForm stockOutDetailForm, Entities.TrnStockCountLineEntity stockOutLineEntity)
        {
            InitializeComponent();

            trnStockCountDetailForm = stockOutDetailForm;
            trnStockCountLineEntity = stockOutLineEntity;
        ...
        public void SaveStockCountLine()
        {
            ...
            var stockOutId = trnStockCountLineEntity.StockCountId;
