...
{
    public partial class TrnStockCountDetailSearchItemForm : Form
    {
        public TrnStockCountDetailForm trnStockCountDetailForm;
        public Entities.TrnStockCountEntity trnStockCountEntity;

        public static List<Entities.DgvStockCountSearchItemListEntity> searchItemListData = new List<Entities.DgvStockCountSearchItemListEntity>();
        public static Int32 pageNumber = 1;
        public static Int32 pageSize = 50;
        public PagedList<Entities.DgvStockCountSearchItemListEntity> searchItemListPageList = new PagedList<Entities.DgvStockCountSearchItemListEntity>(searchItemListData, pageNumber, pageSize);
        public BindingSource searchItemListDataSource = new BindingSource();

        public TrnStockCountDetailSearchItemForm(TrnStockCountDetailForm stockOutDetailForm, Entities.TrnStockCountEntity stockOutEntity)
        {
            InitializeComponent();
        ...
        {
            List<Entities.DgvStockCountSearchItemListEntity> getSearchItemListData = await GetSearchItemListDataTask();
            if (getSearchItemListData.Any())
            {
                searchItemListData = getSearchItemListData;
                searchItemListPageList = new PagedList<Entities.DgvStockCountSearchItemListEntity>(searchItemListData, pageNumber, pageSize);
            ...
            else
            {
                ...
                searchItemListData = new List<Entities.DgvStockCountSearchItemListEntity>();
                searchItemListDataSource.Clear();
                textBoxSearchItemListPageNumber.Text = "1 / 1";
            }
        }

        public Task<List<Entities.DgvStockCountSearchItemListEntity>> GetSearchItemListDataTask()
        {
            ...
            if (listSearchItem.Any())
            {
                var items = from d in listSearchItem
                            select new Entities.DgvStockCountSearchItemListEntity
                            {
            ...
            {
                return Task.FromResult(new List<Entities.DgvStockCountSearchItemListEntity>());
            }
        }
        ...
        private void dataGridViewSearchItemList_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridViewSearchItemList.CurrentCell.ColumnIndex == dataGridViewSearchItemList.Columns["ColumnSearchItemListButtonPick"].Index)
            {
                ...
                TrnStockCountDetailStockCountLineItemDetailForm trnStockCountDetailStockCountLineItemDetailForm = new TrnStockCountDetailStockCountLineItemDetailForm(trnStockCountDetailForm, trnStockCountLineEntity);
        ...
        {
            searchItemListPageList = new PagedList<Entities.DgvStockCountSearchItemListEntity>(searchItemListData, 1, pageSize);
            searchItemListDataSource.DataSource = searchItemListPageList;
        ...
        {
            searchItemListPageList = new PagedList<Entities.DgvStockCountSearchItemListEntity>(searchItemListData, searchItemListPageList.PageCount, pageSize);
            searchItemListDataSource.DataSource = searchItemListPageList;
