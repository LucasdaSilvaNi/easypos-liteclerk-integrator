...
{
    public partial class RepSalesReportCollectionDetailFacepayReportForm : Form
    {
        ...
        public RepSalesReportCollectionDetailFacepayReportForm(DateTime filterStartDate, DateTime filterEndDate, Int32 filterTerminalId, String filterPrintPath)
        {
            InitializeComponent();
