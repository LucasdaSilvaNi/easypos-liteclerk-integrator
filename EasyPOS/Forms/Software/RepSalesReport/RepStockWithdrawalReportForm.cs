...
{
    public partial class RepStockWithdrawalReportForm : Form
    {
        ...
        public IQueryable<Data.TrnCollection> collections;

        public RepStockWithdrawalReportForm(DateTime filterStartDate, DateTime filterEndDate, Int32 filterTerminalId)
        {
            InitializeComponent();
            ...
            Int32 paperSizeHeight = 850;

            collections = from d in db.TrnCollections
            ...
            Console.WriteLine(paperSizeHeight);

            DialogResult printerDialogResult = printDialogStockWithdrawalReport.ShowDialog();
            if (printerDialogResult == DialogResult.OK)
            {
                printDocumentDeliveryReceipt.DefaultPageSettings.PaperSize = new PaperSize("Delivery Receipt", 1200, paperSizeHeight);
                printDocumentDeliveryReceipt.PrinterSettings.PrinterName = printDialogStockWithdrawalReport.PrinterSettings.PrinterName;
        ...
        private void printDocumentDeliveryReceipt_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            if (collections.Any())
            {
                ...
                foreach (var collection in collections)
                {
                    ...
                    // =============================
                    String term = collection.MstCustomer.MstTerm.Term;
                    String dueDate = collection.CollectionDate.AddDays(Convert.ToDouble(collection.MstCustomer.MstTerm.NumberOfDays)).Date.ToShortDateString();
                    String deliveryDate = collection.CollectionDate.ToShortDateString();
                    ...
                    // Customer
                    // ========
                    String customer = collection.MstCustomer.Customer;
                    ...
                    // Address
                    // =======
                    String address = collection.MstCustomer.Address;
                    ...
                    if (collection.TrnSale.TrnSalesLines.Any())
                    {
                        var salesLines = collection.TrnSale.TrnSalesLines.ToList();
                    ...
                    // Total
                    // =====
                    graphics.DrawString("DR No.: " + collection.CollectionNumber, fontArial11Bold, drawBrush, new RectangleF(x, y + 5, 245.0F, height), drawFormatLeft);
                    ...
                    y += graphics.MeasureString(ORFooter, fontArial10Bold).Height + 5;

                    var difference = pageHeight - y;
